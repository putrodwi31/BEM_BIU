...
class Auth extends CI_Controller
{
    ...
    //     $mail->SMTPAuth = true;
    //     $mail->Username = 'email@gmail.com'; // user email
    //     $mail->Password = 'qnyaugakeczanoww'; // password email
    //     $mail->SMTPSecure = 'ssl';
    //     $mail->Port     = 465;

    //     $mail->setFrom('email@gmail.com', 'Pemdusi Web Dev'); // user email
    ...
    //             Hai!,
    //             Permintaan reset password anda, Abaikan email ini jika anda tidak melakukanya. Langkah selanjutnya adalah mengganti password anda dengan mengklik tombol di bawah ini.
    ...
    //         if ($ceknama > 0) {
    //             $this->session->set_flashdata('message', '<div class="alert alert-info" role="alert">Nama anda sudah terdaftar, Silahkan hubungi admin untuk perubahan data</div>');
    //             redirect('auth/pendaftarananggota');
    //         } else {
    //             $data = [
    ...
    //             $this->session->set_flashdata('message', '<div class="alert alert-success" role="alert">Pendaftaran Berhasil, silahkan tunggu konfirmasi dari admin.</div>');
    //             redirect('auth/pendaftarananggota');
    //         }
    //     }
    // }
